...
const redirectUrl = 'http://06ba2623.ngrok.io/oauth/';
...
request({
    ...
    json: {
      ...
      redirect_uri:"http://06ba2623.ngrok.io/oauth/"
    },
    form: {
      grant_type: "authorization_code",
      code:code,client_id:clientID,
...
app.listen(3003, () => console.log('Zoom api oauth sample app listening on port 3003'))
